...
export default function CreateEditWineForm({ id }: { id: number | null }) {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (id) {
      ...
      const formValues = {
        id: id,
        name: (event.currentTarget.querySelector("#name") as HTMLInputElement)
          ?.value,
  ...
  return (
    <>
      ...
      >
        ...
        {isConsumed && (
          <div className="mb-4">
            <label htmlFor="date_consumed" className="block font-semibold mb-2">
              Date Consumed:
            </label>
            <input
              type="date"
